...
int main(int argc, char* argv[]) {
  ...
  for (size_t i = 0; i < SIZE; ++i)
    for (size_t j = 0; j < SIZE; ++j) tabula_recta[j][i] = abc[(i + j) % SIZE];

  std::cout << "This program uses the Vigenère cipher to encrypt/decrypt the "
               "texts contained in text files.\n";
  std::cout << "If you'd like to take a look at the infamous tabula recta used "
               "as a foundation for the Vigenère cipher,\n";
  ...
  std::cout << "The Vigenère cipher was improved by Bellaso who added the "
               "concept of the secret keyword.\n";
  std::cout << "To enhance encryption, a keyword in a form of the whole string "
  ...
  std::cout << "Now, select the mode. Press E to encrypt and D to decrypt the "
               "file.\n";
